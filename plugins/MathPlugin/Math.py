...
class Math:
    ...
    @sk_function_context_parameter(
        name="trial_balance",
        description="Trial Balance from the Database",
    )
    def processTieIn(self, context: SKContext) -> str:
        return str(float(context["value"]) - float(context["trial_balance"]))
